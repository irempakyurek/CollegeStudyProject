package com.example.collegestudy;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Post, BlogzoneViewHolder> FBRA = new FirebaseRecyclerAdapter<Post, BlogzoneViewHolder>(
                Post.class,
                R.layout.card_items,
            ...
            @Override
            protected void populateViewHolder(BlogzoneViewHolder viewHolder, Post model, int position) {
